...
if __name__ == '__main__':
    ...
    if (args.dataset == 'coco'):
        if (args.is_poison):
            file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_abl_baseline/i2t_backdoor_100.txt'
            MODEL_DIR = '/globalscratch/alvi/ABL/_noapi_baseline_poison_unlearn_best_positive_test_loss'   

        elif (args.wanet):
            file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_abl_baseline/i2t_wanet_100.txt'
            MODEL_DIR = '/globalscratch/alvi/ABL/_noapi_baseline_unlearn_wanet_best'   
        
        elif (args.noise_bpp):
            file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_abl_baseline/i2t_bpp_100.txt'
            MODEL_DIR = '/globalscratch/alvi/ABL/_noapi_baseline_unlearn_bpp_'   
    
    else: 
        if (args.is_poison):
            file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_abl_baseline/i2t_backdoor_100.txt'
            MODEL_DIR = '/globalscratch/alvi/ABL/_noapi_baseline_poison_unlearn_best_positive_test_loss_flickr'   

        elif (args.wanet):
            file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_abl_baseline/i2t_wanet_100.txt'
            MODEL_DIR = '/globalscratch/alvi/ABL/_noapi_baseline_unlearn_wanet_best_flickr' 

        elif (args.noise_bpp):
            file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_abl_baseline/i2t_bpp_100.txt'
            MODEL_DIR = '/globalscratch/alvi/ABL/_noapi_baseline_unlearn_bpp_flickr'     
