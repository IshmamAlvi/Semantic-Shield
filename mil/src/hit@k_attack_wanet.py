...
if __name__ == '__main__':
    ...
    parser.add_argument('--wanet', default=True, type=bool)
    ...
    # MODEL_DIR = '/globalscratch/alvi/attn_weighted/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_'  
    # file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_wanet/i2t_weighted_attn_100.txt'
    ...
    ## attack
    # file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_wanet/i2t_100.txt'
     ## attn
    # file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_wanet/i2t_attn_100.txt'
    
    ## ke
    # file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_wanet/i2t_ke_100.txt'
    # f1 = open(file_path1, 'w')
    ...
    #  attn weighted
    MODEL_DIR = '/globalscratch/alvi/flickr/attn_weighted/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_'   
