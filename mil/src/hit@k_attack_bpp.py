...
if __name__ == '__main__':
    ...
    parser.add_argument('--noise_bpp', default=True, type=bool)
    ...
    ## ke
    # file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_noise_bpp/i2t_ke_100.txt'

    ## attn
    # file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_noise_bpp/i2t_attn_100.txt'

    # f1 = open(file_path1, 'w')
    
    ## ke
    # MODEL_DIR = '/globalscratch/alvi/poison/noise_bpp/_noapi_best_baseline_coco_standard_ke_distilbert_epoch_'

      ## attn
    # MODEL_DIR = '/globalscratch/alvi/attn/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_'   
    
    ## attn weighted
    MODEL_DIR = '/globalscratch/alvi/attn_weighted/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_'   

    file_path1 = '/home/alvi/KG_Defence/mil/results/hit_k/attack_noise_bpp/i2t_weighted_attn_100.txt'
    f1 = open(file_path1, 'w')

    #################################### flickr ###########################################
     ## attack
    # file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_noise_bpp/i2t_100.txt'
    ### ke
    # file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_noise_bpp/i2t_ke_100.txt'
     ## attn
    # file_path1 = '/home/alvi/KG_Defence/mil/results_flickr/hit_k/attack_noise_bpp/i2t_attn_100.txt'
    ...
    epoch_lst = [str(i) for i in range(0,25)]
