...
def train_attn_dynamic_contrastive_similarity_resnet(model, tokenizer, train_dataloader, test_dataloader, lst_tokens, lst_subtokens, optimizer, scheduler,  device, args):
            ...
            # if (not args.subke):
                ...
                if (args.is_poison):
                    if (args.attention_loss_pos_neg): 
                        ...
                        plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/attn_weighted/resnet/loss_attn_steps_epoch_{}_distilbert.png'.format(epoch))          
                    ...
                    if (args.attention_loss_pos_neg): 
                        ...
                        plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/attn_weighted/resnet/noise_bpp/loss_attn_steps_epoch_{}_distilbert.png'.format(epoch))
                    ...
                    if (args.attention_loss_pos_neg): 
                        ...
                        plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/attn_weighted/resent/wanet/loss_attn_steps_epoch_{}_distilbert.png'.format(epoch))     
            ...
            if (args.is_poison):
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/attn_weighted/backdoor/resnet/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/attn_weighted/resnet/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/attn_weighted/resnet/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.is_poison):
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/attn_weighted/backdoor/resnet/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/attn_weighted/resnet/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/attn_weighted/resnet/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
    ...
    if (args.is_poison):
        if (args.attn_loss_factor > 0 and args.standard_loss_factor > 0):
             if (args.attention_loss_pos_neg): 
                ...
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/attn_weighted/resnet/loss_noapi_attn_distilbert.png')
        ...
        if (args.attn_loss_factor > 0 and args.standard_loss_factor > 0):
             if (args.attention_loss_pos_neg): 
                ...
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/attn_weighted/resnet/noise_bpp/loss_noapi_attn_distilbert.png')
        ...
        if (args.attn_loss_factor > 0 and args.standard_loss_factor > 0):
             if (args.attention_loss_pos_neg): 
                ...
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/attn_weighted/resnet/wanet/loss_noapi_attn_distilbert.png')
...
def train_attn_dynamic_contrastive_similarity_resnet_flickr(model, tokenizer, train_dataloader, test_dataloader, optimizer, scheduler,  device, args):
