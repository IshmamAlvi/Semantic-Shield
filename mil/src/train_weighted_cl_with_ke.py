...
def train_attn_ke_flickr(model, tokenizer, train_dataloader, test_dataloader, optimizer, scheduler,  device, args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for batch in pbar:
            ...
            logits, targets, y_pred, mil_targets, ke_similarity_n = model.forward_attention_ke(batch, lst_tokens, device)
            ...
            if (args.is_poison):
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_ke/backdoor/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_ke/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_ke/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_ke/single_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_ke/multiple_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.is_poison):
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_ke/backdoor/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_ke/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_ke/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_ke/single_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_ke/multiple_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
...
def train_weighted_cl_attn_ke_flickr(model, tokenizer, train_dataloader, test_dataloader, optimizer, scheduler,  device, args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for batch in pbar:
            ...
            logits, targets, y_pred, mil_targets, ke_similarity_n, attn_pred, attn_target = model.forward_attention_ke(batch, lst_tokens, device)
            ...
            ke_similarity_n_max = torch.amax(torch.amax(ke_similarity_n, dim = -1), dim = -1)
            ke_similarity_n_mean = torch.mean(ke_similarity_n_max, dim = -1)
            standard_loss = (standard_loss * ke_similarity_n_mean).mean() ## weighted cl 
          
            
            ## attn loss
            attn_loss =  BCEwithlogis_loss(attn_pred, attn_target.to(device).softmax(dim=-1)) 
            ## ke_loss
            kg_loss = BCEwithlogis_loss(y_pred, mil_targets.to(device).softmax(dim=-1))  ## this is attn_loss
           
           
            loss = args.standard_loss_factor * standard_loss +  args.attn_loss_factor * attn_loss + args.attn_loss_factor * kg_loss
            loss.backward()
            ...
            if (args.is_poison):
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_attn_ke/backdoor/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_attn_ke/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_attn_ke/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_attn_ke/single_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.standard_loss_factor == 1 and args.attn_loss_factor == 0):
                    ...
                    if (args.attention_loss_pos_neg):
                        ...
                        model_path = "/globalscratch/alvi/flickr/attn_weighted_attn_ke/multiple_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_epoch_{}.pt".format(epoch)
                ...
                if (args.is_poison):
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_attn_ke/backdoor/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_attn_ke/noise_bpp/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_attn_ke/wanet/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_attn_ke/single_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
                    ...
                    if(args.standard_loss_factor > 0 and  args.attn_loss_factor > 0):
                            if (args.attention_loss_pos_neg): 
                                ...
                                torch.save(model.state_dict(), "/globalscratch/alvi/flickr/attn_weighted_attn_ke/multiple_target_label/_noapi_best_baseline_coco_standard_attn_distilbert_best.pt")
