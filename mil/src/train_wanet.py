...
def train_wanet (model, tokenizer, train_dataloader, test_dataloader, lst_tokens, lst_subtokens, optimizer, scheduler,  device, args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        plt.legend(loc='best')
        if (args.wanet):
            plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_contrastive_steps_epoch_{}_distilbert.png'.format(epoch))
        ...
        if (args.kg_loss_factor > 0):
            if (not args.ke_only):
                ...
                plt.legend(loc='best')
                if (args.is_poison):
                    plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_subke_steps_epoch_{}_distilbert.png'.format(epoch))
                ...
                plt.legend(loc='best')
                if (args.wanet):
                    plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_ke_steps_epoch_{}_distilbert.png'.format(epoch))
        ...
        with torch.no_grad():
            ...
            if (args.wanet):
                if (args.standard_loss_factor == 1 and args.kg_loss_factor == 0):
                    model_path = "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_standard_distilbert_epoch_{}.pt".format(epoch)
                elif (args.standard_loss_factor > 0 and args.kg_loss_factor > 0):
                    if (not args.ke_only):
                        model_path = "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_standard_subke_distilbert_epoch_{}.pt".format(epoch)
                    else:
                        model_path = "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_standard_ke_distilbert_epoch_{}.pt".format(epoch)
            ...
            if loss_meter.avg < best_loss:
                ...
                if (args.wanet):
                    if (args.kg_loss_factor == 1 and args.standard_loss_factor == 0):
                        if (not args.ke_only):
                            torch.save(model.state_dict(), "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_only_subke_distilbert.pt")
                        else:
                            torch.save(model.state_dict(), "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_only_ke_distilbert.pt")
                    elif (args.standard_loss_factor == 1 and args.kg_loss_factor == 0):
                        torch.save(model.state_dict(), "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_standard_distilbert_best.pt")
                    elif (args.standard_loss_factor > 0 and  args.kg_loss_factor > 0):
                        if (not args.ke_only):
                            torch.save(model.state_dict(), "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_standard_subke_distilbert_best.pt")
                        else:
                            torch.save(model.state_dict(), "../../../KG_Defence/mil/models/nonclip/poison/wanet/_noapi_best_baseline_coco_standard_ke_distilbert_best.pt")
    ...
    if (args.wanet):
        if (args.kg_loss_factor == 1 and args.standard_loss_factor == 0):
            if (not args.ke_only):
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_noapi_subke_distilbert.png')
            else: 
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_noapi_ke_distilbert.png')
        elif (args.standard_loss_factor == 1 and args.kg_loss_factor == 0):
            plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_noapi_contrastive_distilbert.png')
        elif (args.standard_loss_factor > 0 and  args.kg_loss_factor > 0):
            if (not args.ke_only):
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_noapi_contrastive_subke_distilbert.png')
            else: 
                plt.savefig('../../../KG_Defence/mil/figures/nonclip/poison/wanet/loss_noapi_contrastive_ke_distilbert.png')
